                ...
                html.Div(
                    [
                        ...
                        dcc.RadioItems(
                            ...
                            options=[
                                {"label": "Option1 ", "value": "all"},
                                {"label": "Option2 ", "value": "active"},
                                {"label": "Option3 ", "value": "custom"},
                            ],
                            value="active",
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    [html.H6(id="well_text"), html.P("Produced CO2")],
                                    id="wells",
...
def make_count_figure(well_statuses, well_types, year_slider):
    ...
    layout_count["title"] = "Complete CO2 Data"
